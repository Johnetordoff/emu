...
class BulkUploadContributors(
    LoginRequiredMixin, generic.TemplateView, generic.FormView
):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            user.bulk_contributors_csv = (
                form.cleaned_data["contributors_csv"] or user.bulk_contributors_csv
            )
            user.save()
